---
station: chs-nakwakto-rapids
transit_window_minutes: 5
hazards:
  - state: any
    text: >-
      Slack lasts about six minutes, and CHS is unusually blunt that the rapids
      cannot be run with any degree of safety at any other time. Turret Rock
      (locally Tremble Island) sits mid-channel and the main strength of the
      stream piles onto it in both directions, with reefs reaching up to 0.1
      mile south-southwest of it. Either side is passable; the west channel is
      the preferred one.
  - state: flood
    text: >-
...
not share a window: the Outer Narrows at the west end of Slingsby (about 0.1 mile
wide, 7 knots flooding and 9 ebbing, slack about 15 minutes) and then Nakwakto
itself, where slack is six minutes. Treadwell Bay is the bay CHS names for
waiting out the turn — good holding, sheltered from the streams, and small enough
that a shore tie is recommended for lack of swinging room. There are no ports,
marinas or services anywhere in the area; arrive self-sufficient.
...
all secondary — but it does say the stream's full strength lands on the rock in
the middle of the channel, which amounts to the same warning.
